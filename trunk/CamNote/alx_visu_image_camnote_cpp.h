...
class alx_visu_image_camnote_cpp : public alx_visu_image_cpp
{
 protected:
   ...
   inline void Changement_activation_pix_mirroirs()
    {L_rappel_activation_pix_mirroir.Rappeler(&activation_pix_mirroirs);
     alx_classe_base_model::nb_infos_comp = 3;
     alx_classe_base_model::infos_comp[0] = 1;
     alx_classe_base_model::infos_comp[1] = 0;
     alx_classe_base_model::infos_comp[2] = (int)(void*)(&activation_pix_mirroirs);
 ...
 public:
   alx_visu_image_camnote_cpp( char *nom
   ...
   inline virtual void Activation_pix_mirroir(const bool b) {activation_pix_mirroirs = b; Changement_activation_pix_mirroirs();}
   inline const bool Activation_pix_mirroir() const {return activation_pix_mirroirs;}
