...
#define SWIG_init    Tk_capture_bitmap_swig_Init
#define SWIG_name    "tk_capture_bitmap_swig"
#define SWIG_prefix  ""
...
#include "tk_capture_bitmap.h"

#ifdef __cplusplus
extern "C" {
#endif
SWIGINTERN int
_wrap_get_Buffer_for_HBITMAP_pixels(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  void *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":get_Buffer_for_HBITMAP_pixels ") == TCL_ERROR) SWIG_fail;
  result = (void *)get_Buffer_for_HBITMAP_pixels();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "get_Buffer_for_HBITMAP_pixels", (swig_wrapper_func) _wrap_get_Buffer_for_HBITMAP_pixels, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Tk_capture_bitmap_swig_SafeInit(Tcl_Interp *interp) {
